...
const POCKET_NETWORK_APP_AUTH_TOKEN = {
	...
	applicationSignature:
		'8e0bfcdff2dcd41e44484bfc17ee5b7f2e5e76b6815b079a1cc12abf6620250709f25e1162c0830d1650799e7e9917f0083987caee8ea4bcee6abb53536e0703'
};
...
async function getPocketInstance() {
	if (!pocketInstance || !pocketAAT) {
		...
		pocketAAT = await unlockAAT(
			pocketInstance,
			POCKET_NETWORK_APP_AUTH_TOKEN,
			POCKET_NETWORK_PPK,
...
export async function getPocketNetwork(network: Ethereum.Network) {
	...
	const provider = new PocketProvider(
		pocketNetworkChainIDs[network.chainId],
		pocketAAT,
		pocketInstance
	);
