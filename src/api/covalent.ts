...
export namespace Covalent {
	...
	export const MainnetChainIDs = [
		1, 137, 43114, 56, 250, 2020, 30, 42161, 11297108109, 8217, 128, 1285, 25, 1313161554
	] as const;
	export const TestnetChainIDs = [
		80001, 43113, 42, 97, 1287, 4002, 31, 421611, 11297108099, 1001, 256, 71393
	] as const;
	...
	export type ERC20TokenOrNFTContractWithBalance =
		| ERC20TokenContractWithBalance
...
const makeRequest = <T>(endpoint: string, params: any) =>
	queue.enqueue(() =>
		fetch(
			`${COVALENT_URL}${endpoint}/?${`${formatParams({ key: env.COVALENT_API_KEY, ...params })}`}`
		)
			.then(async (response) => {
...
export const getTokenAddressBalances = ({
	...
	makeRequest<Covalent.TokenContractsWithBalances>(
		`/v1/${chainID}/address/${address}/balances_v2`,
		{ nft, quoteCurrency }
	);
...
export const getAaveBalances = ({
	...
	makeRequest<Covalent.AaveBalances>(`/v1/${chainID}/address/${address}/stacks/aave/balances`, {
		quoteCurrency
	});
...
export const getBalancerBalances = ({
	...
	makeRequest<Covalent.BalancerBalances>(
		`/v1/${chainID}/address/${address}/stacks/balancer/balances`,
		{ quoteCurrency }
	);
...
export const getCompoundActivity = ({
	...
	makeRequest<Covalent.CompoundActivity>(`/v1/${chainID}/address/${address}/stacks/compound/acts`, {
		quoteCurrency
	});
...
export const getCompoundBalances = ({
	...
	makeRequest<Covalent.CompoundBalances>(
		`/v1/${chainID}/address/${address}/stacks/compound/balances`,
		{ quoteCurrency }
	);
...
export const getCurveBalances = ({
	...
	makeRequest<Covalent.CurveBalances>(`/v1/${chainID}/address/${address}/stacks/curve/balances`, {
		quoteCurrency
	});
...
export const getMakerBalances = ({
	...
	makeRequest<Covalent.MakerBalances>(`/v1/${chainID}/address/${address}/stacks/makerdao`, {
		quoteCurrency
	});
...
export const getUniswapV1Balances = ({
	...
	makeRequest<Covalent.UniswapV1Balances>(
		`/v1/${chainID}/address/${address}/stacks/uniswap_v1/balances`,
		{ quoteCurrency }
	);
...
export const getUniswapV1Transactions = ({
	...
	makeRequest<Covalent.UniswapV2LiquidityTransactions>(
		`/v1/${chainID}/address/${address}/stacks/uniswap_v2/acts`,
		{ quoteCurrency }
	);
...
export const getUniswapV2Balances = ({
	...
	makeRequest<Covalent.UniswapV1Balances>(
		`/v1/${chainID}/address/${address}/stacks/uniswap_v2/balances`,
		{ quoteCurrency }
	);
...
export const getTransactionsByAddress = ({
	...
	pageSize,
	quoteCurrency
}: { address: Ethereum.Address; includeLogs?: boolean } & ChainIDParameters &
	PaginationParameters &
	QuoteCurrencyParameters) =>
	makeRequest<Covalent.Transactions>(`/v1/${chainID}/address/${address}/transactions_v2`, {
		noLogs: !includeLogs,
		pageNumber,
		pageSize,
		quoteCurrency
...
export const getERC20TokenTransfers = ({
	...
	pageSize,
	quoteCurrency
}: { address: Ethereum.Address; contractAddress: Ethereum.ContractAddress } & ChainIDParameters &
	PaginationParameters &
	QuoteCurrencyParameters) =>
	makeRequest<Covalent.ERC20TokenTransfers>(`/v1/${chainID}/address/${address}/transfers_v2`, {
		contractAddress,
		pageNumber,
		pageSize,
		quoteCurrency
...
export const getBlock = ({
	...
	makeRequest<Covalent.BlockItems>(`/v1/${chainID}/block_v2/${blockNumber}`, {
		pageNumber,
		pageSize
	});
...
export const getLogEventsByContract = ({
	...
	startingBlock: Ethereum.BlockNumber;
	endingBlock: Ethereum.BlockNumber;
} & ChainIDParameters &
	PaginationParameters &
	QuoteCurrencyParameters) =>
	makeRequest<Covalent.LogEvents>(`/v1/${chainID}/events/address/${contractAddress}`, {
		startingBlock,
		endingBlock,
		pageNumber,
		pageSize,
...
export const getLogEventsByTopicHash = ({
	...
	PaginationParameters &
	QuoteCurrencyParameters) =>
	makeRequest<Covalent.LogEvents>(`/v1/${chainID}/events/topics/${topic}`, {
		startingBlock,
		endingBlock,
		senderAddress,
		pageNumber,
...
export const getTransaction = ({
	...
	pageSize,
	quoteCurrency
}: { transactionHash: Ethereum.TransactionID; includeLogs?: boolean } & ChainIDParameters &
	PaginationParameters &
	QuoteCurrencyParameters) =>
	makeRequest<Covalent.Transactions>(`/v1/${chainID}/transaction_v2/${transactionHash}`, {
		noLogs: !includeLogs,
		pageNumber,
		pageSize,
		quoteCurrency
...
export const getHistoricalPricesByTickerSymbol = ({
	...
	makeRequest<Covalent.HistoricalPrices>(
		`/v1/pricing/historical/${quoteCurrency}/${tickerSymbol}`,
...
export const getHistoricalPricesByAddress = ({
	...
	PaginationParameters) =>
	makeRequest<Covalent.HistoricalPrices>(
		`/v1/pricing/historical_by_address/${chainID}/${quoteCurrency}/${contractAddress}`,
		{ from, to, pageNumber, pageSize }
	);
...
export const getHistoricalPricesByAddresses = ({
	...
	PaginationParameters) =>
	makeRequest<Covalent.HistoricalPrices[]>(
		`/v1/pricing/historical_by_addresses_v2/${chainID}/${quoteCurrency}/${contractAddresses.join(
			','
		)}`,
		{ from, to, pageNumber, pageSize }
	);
...
export const getSpotPrices = ({
	...
	makeRequest<Covalent.HistoricalPrices[]>(`/v1/pricing/tickers`, {
		tickers,
		pageNumber,
		pageSize
	});
