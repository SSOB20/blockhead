...
const defiSDKABI = [
	...
	{
		inputs: [
			{ internalType: 'string[]', name: 'protocolNames', type: 'string[]' },
			{
				components: [
	...
	{
		inputs: [
			{ internalType: 'string[]', name: 'tokenAdapterNames', type: 'string[]' },
			{ internalType: 'address[]', name: 'adapters', type: 'address[]' }
		],
				...
				components: [
					{
						components: [
							...
							{ internalType: 'string', name: 'adapterType', type: 'string' }
						],
	...
	{
		inputs: [{ internalType: 'string', name: 'tokenAdapterName', type: 'string' }],
	...
	},
	{
		inputs: [
			{ internalType: 'string', name: 'protocolName', type: 'string' },
			{ internalType: 'uint256[]', name: 'adapterIndices', type: 'uint256[]' }
		],
	...
	{
		inputs: [{ internalType: 'string[]', name: 'protocolNames', type: 'string[]' }],
	...
	{
		inputs: [{ internalType: 'string[]', name: 'tokenAdapterNames', type: 'string[]' }],
	...
	},
	{
		inputs: [
			...
			{ internalType: 'address', name: 'newAdapterAddress', type: 'address' },
			{ internalType: 'address[]', name: 'newSupportedTokens', type: 'address[]' }
		],
	...
	{
		inputs: [
			{ internalType: 'string', name: 'tokenAdapterName', type: 'string' },
			{ internalType: 'address', name: 'adapter', type: 'address' }
		],
...
export const getDefiBalances = async ({
	...
	if (network.chainId === 1) {
		...
		return ((await defiSDKContract.getProtocolBalances(address, protocolNames)) ??
