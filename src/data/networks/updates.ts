	...
	[
		...
		[
			...
			// },
			{
				...
				links: ['https://blog.ethereum.org/2022/08/24/mainnet-merge-announcement']
			},
			{
				name: 'Gray Glacier',
				blockNumber: 15050000,
				consensus: consensusMechanisms.ethash,
				links: ['https://blog.ethereum.org/2022/06/16/gray-glacier-announcement']
			},
			{
				name: 'Arrow Glacier',
				blockNumber: 13773000,
				consensus: consensusMechanisms.ethash,
				links: ['https://blog.ethereum.org/2021/11/10/arrow-glacier-announcement']
			},
			{
				name: 'London',
			...
			},
			{
				...
				hardForks: [networksBySlug['ethereum-classic']]
			},
			{
				name: 'Homestead',
				blockNumber: 1150000,
			...
			},
			{
				...
				blockNumber: 0,
				consensus: consensusMechanisms.ethash,
				links: ['https://blog.ethereum.org/2015/07/27/final-steps']
			}
		]
	]
]);
