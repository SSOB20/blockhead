...
const getQuickNodeProvider = async ({ network }: { network: Ethereum.Network }) =>
...
export const fetchNFTs = async ({
	...
	if (network.chainId !== 1) throw new Error('QuickNode only supports fetching NFTs on Ethereum.');
